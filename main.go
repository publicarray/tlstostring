...
// TLSVersionMap maps uint16 to strings
var TLSVersionMap = map[uint16]string{
	0x0300: `SSL 3.0`,
	0x0301: `TLS 1.0`,
	0x0302: `TLS 1.1`,
	0x0303: `TLS 1.2`, // tls1.2 and tls1.3
}

// CipherSuiteMap maps uint16 to strings
// Taken from https://www.iana.org/assignments/tls-parameters/tls-parameters.xml
var CipherSuiteMap = map[uint16]string{
	// OLD cipher suites (used for research)
	// https://godoc.org/github.com/zmap/zcrypto/tls#pkg-constants
...
// Version to string
func Version(version uint16) string {
	return TLSVersionMap[version]
}

// CipherSuite to string
func CipherSuite(chipher uint16) string {
	return CipherSuiteMap[chipher]
}
